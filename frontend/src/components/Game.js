...
// All the game data and helper functions from App.js are moved here
...
const initialLocations = {
    ...
    "Bermuda Triangle": {
      description: "A mysterious triangular vortex where time flows in reverse.",
      welcome: "🔺 Entering Bermuda Triangle! Time is flowing backward!",
      key: "Triangle Key",
      exits: {},
      timeEffect: "reverse",
      hasQuestion: true,
    ...
    "Stonehenge": {
      description: "Ancient stone circles where time moves normally.",
      welcome: "🗿 Welcome to Stonehenge!",
      key: "Stone Key",
      exits: {},
      timeEffect: "normal",
      hasQuestion: true,
    ...
    "Crooked Forest": {
      description: "A twisted woodland where time moves normally.",
      welcome: "🌲 Entering Crooked Forest!",
      key: "Forest Key",
      exits: {},
      timeEffect: "normal",
      hasQuestion: true,
...
const Game = ({ currentUser, onLogout, systemTime }) => {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
          setGameState((prev) => {
            ...
            if (prev.location === "Bermuda Triangle") {
    ...
    useEffect(() => {
        ...
        log("🌟 ═══════════════════════════════════════════════════════════════════════════════════════════", "success");
        log("");
        log(`👤 Logged in as: ${currentUser}`, "success");
    ...
    function askQuestion() {
        ...
        if (currentLocation.hasQuestion && !currentLocation.questionAnswered) {
          ...
          log("💭 Type your answer and press Enter.");
          setGameState((prev) => ({
            ...prev,
            awaitingAnswer: true,
    ...
    function handleCommand(e) {
        ...
        switch (command) {
          case "help":
            ...
            log("• logout - Log out and return to login");
            log("");
            log("💡 TIP: When a question is asked, just type your answer and press Enter.");
            log("");
            break;
          case "logout":
            onLogout();
    ...
    // This is the UI from App.js, now inside the Game component
    return (
        <div>
        {isWinPopupVisible && (
        ...
        <div id="status-panel">
            <div className="status-item">
                <span className="status-label">🕒 IST Time:</span>
        ...
        <form className="input-area-wrap" onSubmit={handleCommand}>
            <input
            id="cmd"
            placeholder="Enter command, or your answer to a question..."
            autoFocus
            value={input}
